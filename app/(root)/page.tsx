  ...
  return (
    <>
     <section className='bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10'>
      <div className='wrapper grid grod-cols-1 gap-5 md:grid-cols-2 2xl:gap-0'>
        <div className='flex flex-col justify-center gap-8'>
          <h1 className='h1-bold'>Host, Connect and Visit: Your Listings, Our Platform!</h1>
          <p className='p-regular-20 md:p-regular-24'>Buy and improve living from all over the world from world-class agents with our global community.</p>
          <Button size='lg' asChild className='button w-full sm:w-fit'>
            <Link href='#houses'> Explore Now</Link>
          </Button>
        </div>
